  ...
  )
{
  ...
  // lines long.
  DEBUG ((DEBUG_INFO, "EventLogFormat - 0x%08x\n", EventLogFormat));
  DEBUG ((DEBUG_INFO, "EventLogLocation - 0x%08x\n", EventLogLocation));
  DEBUG ((DEBUG_INFO, "EventLogLastEntry - 0x%08x\n", EventLogLastEntry));
  DEBUG ((DEBUG_INFO, "FinalEventsTable - 0x%08x\n", FinalEventsTable));
...
/**
  ...
  @param[in]  Digest     The digest to be dumped.
**/
VOID
EFIAPI
DumpPcrDigest (
